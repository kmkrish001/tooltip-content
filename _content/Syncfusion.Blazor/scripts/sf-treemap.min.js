...
window.sfBlazor.Treemap = function () {
  ...
  function () {
    ...
    SfTreemap.prototype.mouseMove = function (event) {
      ...
      if (this.dotNetRef) {
        this.dotNetRef.invokeMethodAsync('TriggerMouseMove', event.target.id, mouseX, mouseY, false);
      }
...
}]);(async()=>{await import("/_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js").then(()=>{sfBlazor.loadDependencies('sftreemap');})})();