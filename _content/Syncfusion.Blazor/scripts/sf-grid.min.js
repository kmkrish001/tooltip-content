...
window.sfBlazor.Grid = function () {
  ...
  function () {
    ...
    Freeze.prototype.setFrozenHeight = function (minWidth) {
      ...
      this.parent.scrollModule.getScrollbar().style.display = this.parent.scrollModule.removeUnwantedScroll("Width", minWidth) ? "none" : "flex"; //if (movableContent.scrollWidth - movableContent.clientWidth) {
  ...
  function () {
    ...
    ColumnWidthService.prototype.calcMovableOrFreezeColWidth = function (tableType) {
      ...
      var left = this.parent.options.frozenLeftColumnsCount || this.parent.options.frozenColumns;
  ...
  function () {
    ...
    Selection.prototype.mouseMoveHandler = function (e) {
      ...
      if (!this.isCellDrag || this.parent.options.allowDragSelection && !this.parent.options.enableAutoFill && this.isCellDrag) {
        ...
        this.element.style.top = y1 - siblingHeight + 'px';
  ...
  function () {
    function VirtualContentRenderer(parent) {
      ...
      this.bindScrollEvent = function () {
        _this_1.observer.observe(function (scrollArgs) {
          if (_this_1.parent.options.enableVirtualization) _this_1.scrollListener(scrollArgs);
        }, _this_1.onEntered());
    ...
    VirtualContentRenderer.prototype.setVirtualHeight = function () {
      ...
      if (!this.parent.options.allowEditing) {
  ...
  function () {
    ...
    FrozenDD.prototype.dragStart = function (e) {
      if (e.target.classList.contains(frozenDragClassList.cursor)) {
        ...
        this.isLeftCursorDragging = this.currentCursorElement.classList.contains('e-frozen-left-cursor') && !this.currentCursorElement.classList.contains('e-frozen-default-cursor') || this.currentCursorElement.classList.contains('e-frozen-default-cursor') && this.currentCursorElement.classList.contains('e-frozen-right-cursor') ? true : false;
        this.appendHelper();
    ...
    FrozenDD.prototype.setHelperHeight = function () {
      ...
      if (frzCols && headercell.parentElement.children.length && !headercell.parentElement.children[0].classList.contains('e-stackedheadercell')) {
        if (parentsUntil(headercell, 'e-movableheader')) {
          tr = [].slice.call(this.parent.getHeaderContent().querySelector('.e-movableheader').querySelectorAll('tr'));
        } else if (parentsUntil(headercell, 'e-frozen-right-header')) {
          tr = [].slice.call(this.parent.getHeaderContent().querySelector('.e-frozen-right-header').querySelectorAll('tr'));
        } else {
          tr = [].slice.call(this.parent.getHeaderContent().querySelector('.e-frozen-left-header').querySelectorAll('tr'));
        }
      ...
      if (!this.currentCursorElement.classList.contains('e-frozen-default-cursor')) {
        if (parentsUntil(headercell, 'e-frozen-right-content') || parentsUntil(headercell, 'e-frozen-right-header')) {
    ...
    FrozenDD.prototype.setColumnsForBorderUpdate = function () {
      ...
      if (this.parent.options.actualFrozenColumns > 0) {
        ...
        var movableColumns = gridColumns.filter(function (col) {
          return col.index > _this.parent.options.actualFrozenColumns - 1 && !col.isFrozen;
        });
    ...
    FrozenDD.prototype.updateBorder = function () {
      ...
      var helperPosition = this.isLeftCursorDragging ? this.convertWidthToNumber(this.helperElement.style.left) : -this.calcPos(this.helperElement).right;
      ...
      if (!sf.base.isNullOrUndefined(index) && this.currentBorderIndex != index || this.frozenDefaultBorderClass != 'default' && index == this.currentBorderIndex) {
        ...
        if (!sf.base.isNullOrUndefined(this.parent.getHeaderContent().querySelectorAll('[e-mappinguid=' + borderColumnUID + ']')[0])) {
          this.borderHeaderCell = this.parent.getHeaderContent().querySelectorAll('[e-mappinguid=' + borderColumnUID + ']')[0].parentElement;
        }
    ...
    FrozenDD.prototype.convertWidthToNumber = function (widthInString) {
      var widthInNumber = Number(widthInString.replace('px', ''));
    ...
    FrozenDD.prototype.scrollHorizontally = function () {
      if (this.parent.options.frozenColumns != 0) {
        ...
        if (movableContent.scrollWidth > movableContent.clientWidth) {
          ...
          movableContent.scrollLeft = this.isLeftCursorDragging ? 0 : movableChildScrollBar.scrollWidth - movablescrollbar.offsetWidth;
        }
      }
    };

    FrozenDD.prototype.updateHelper = function (e) {
      var mouseX = this.getCurrentPageX(e);
    ...
    FrozenDD.prototype.getCurrentPageX = function (e) {
      if (e.touches && e.touches.length) {
        return e.touches[0].pageX;
      } else {
        return e.pageX;
    ...
    FrozenDD.prototype.dragEnd = function (e) {
      ...
      if (!this.checkForServerCall(params.isFrozen, params.frozenColumnsUidCollection)) {
        return;
      }
    ...
    FrozenDD.prototype.checkForServerCall = function (isFrozen, frozenColumnsUidCollection) {
  ...
  function () {
    function SfGrid(dataId, element, options, dotnetRef) {
      ...
      if (!sf.base.isNullOrUndefined(gridInstance.element)) {
        gridInstance.blazor__instance = this;
    ...
    SfGrid.prototype.getSelectedRowIndexes = function (isVirtualScroll) {
      ...
      for (var i = 0; i < rows.length; i++) {
        if (rows[i].hasAttribute('aria-selected') && rows[i].getAttribute('aria-selected') === "true") {
          var rowIndex = this.options.allowDragSelection && this.options.enableVirtualization || isVirtualScroll ? parseInt(rows[i].getAttribute('aria-rowindex'), 10) : i;
    ...
    */
    ...
    SfGrid.prototype.contentReady = function (action) {
      ...
      if (!this.isGridFirstRender && this.options.frozenColumns && this.options.enablePersistence) {
        var widthService = new ColumnWidthService(this);
        widthService.setWidthToTable();
      }
  ...
  var Grid = {
    ...
    contentReady: function contentReady(dataId, options, action) {
      var gridInstance = window.sfBlazor.getcompInstance(dataId);
      ...
      if (!sf.base.isNullOrUndefined(gridInstance.element) && !sf.base.isNullOrUndefined(gridInstance.element.blazor__instance)) {
        ...
        if (options.enableColumnVirtualization && options.height == "100%") {
    ...
    searchClear: function searchClear(dataId, inputId) {
      var gridInstance = window.sfBlazor.getcompInstance(dataId);
    ...
    clientTransformUpdate: function clientTransformUpdate(dataId, xPosition, yPosition) {
      var gridInstance = window.sfBlazor.getcompInstance(dataId);

      if (!sf.base.isNullOrUndefined(gridInstance.element) && !sf.base.isNullOrUndefined(gridInstance.element.blazor__instance)) {
        gridInstance.element.blazor__instance.virtualContentModule.updateTransform(xPosition, yPosition);
      }
    },
    autoFitColumns: function autoFitColumns(dataId, columns, fieldNames) {
      var gridInstance = window.sfBlazor.getcompInstance(dataId);
    ...
    focus: function focus(dataId, rowuid, celluid, action) {
      var gridInstance = window.sfBlazor.getcompInstance(dataId);
    ...
    focusChild: function focusChild(dataId, rowuid, celluid) {
      ...
      var child = [].slice.call(gridInstance.element.querySelector("[data-uid=\"" + celluid + "\"]").querySelectorAll(query));
      /* Select the first focusable child element
       * if no child found then select the cell itself.
       * if Grid is in editable state, check for editable control inside child.
       */

      child.length > 0 ? child[0].focus() : gridInstance.element.querySelector("[data-uid=\"" + celluid + "\"]").focus();
    ...
    destroy: function destroy(dataId) {
      ...
      if (!sf.base.isNullOrUndefined(gridInstance.element) && !sf.base.isNullOrUndefined(gridInstance.element.blazor__instance)) {
        gridInstance.element.blazor__instance.destroy();
      }
    },
    ...
    focusCell: function focusCell(dataId, field, isAdd, frozenEdit) {
      ...
      } else if (field !== "" && gridInstance.element.querySelector(complexField)) {
        gridInstance.element.querySelector(complexField).focus();
      }
    },
...
}]);(async()=>{await import("/_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js").then(()=>{sfBlazor.loadDependencies('sfgrid');})})();