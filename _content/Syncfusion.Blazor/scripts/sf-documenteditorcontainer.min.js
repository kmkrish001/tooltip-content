...
window.sfBlazor.DocumentEditorContainer = function () {
  ...
  function () {
    ...
    SfDocumentEditorContainer.prototype.initializeDocumentEditor = function (dataId, element) {
      ...
      this.documentEditorInternal = instance; //(this.element as HTMLElement).appendChild(documentEditorTarget);
  ...
  var DocumentEditorContainer = {
    ...
    initialize: function initialize(dataId, element, docEditDataId, docEditElement, containerOptions, editorOptions, dotnetRef, elements) {
      ...
      var docEdit = new SfDocumentEditorContainer(dataId, element, containerOptions, editorOptions, dotnetRef); //docEdit.textProperties = new TextProperties(elements[0]);
        ...
        return __generator(this, function (_a) {
          ...
          fileReader.onload = function () {
            ...
            image.addEventListener('load', function () {
              instance.editor.insertImage(data, this.width, this.height);
            });
            image.src = data;
          };
