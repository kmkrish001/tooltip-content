...
window.sfBlazor.Tooltip = function () {
  ...
  function () {
    ...
    SfTooltip.prototype.collisionFlipFit = function (target, x, y) {
      ...
      if (window.scrollX && this.properties.position == BOTTOMRIGHT) {
    ...
    updateProperties: function updateProperties(element, completeProps, props) {
     ...
     // this.updateAnimation(completeProps.animation);
      ...
      if (props.target || props.opensOn || !sf.base.isNullOrUndefined(props.isSticky)) {
        ...
        console.log(blazInstance.tooltipEle);
        if (blazInstance.tooltipEle) {
          console.log(blazInstance.isPositionUpdate);
...
}]);(async()=>{await import("/_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js").then(()=>{sfBlazor.loadDependencies('sftooltip');})})();