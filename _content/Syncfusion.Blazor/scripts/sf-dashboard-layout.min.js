...
window.sfBlazor.DashboardLayout = function () {
  ...
  function () {
    function SfDashboardLayout(element, dotnetRef) {
      ...
      this.isChanged = false; // Defines whether the drag operation is performed or not.
...
}]);(async()=>{await import("/_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js").then(()=>{sfBlazor.loadDependencies('sfdashboardlayout');})})();