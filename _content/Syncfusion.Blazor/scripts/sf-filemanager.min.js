...
window.sfBlazor.FileManager = function () {
  ...
  function () {
    function SfFileManager(element, ref, properties) {
      ...
      this.dotnetRef = ref; // eslint-disable-next-line
...
}]);(async()=>{await import("/_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js").then(()=>{sfBlazor.loadDependencies('sffilemanager');})})();