...
window.sfBlazor.Maps = function () {
  ...
  function () {
    ...
    SfMaps.prototype.mouseMove = function (event) {
      ...
      if (!sf.base.isNullOrUndefined(this.legendSettings) && this.legendSettings.mode === 'Interactive' && (id.indexOf('_MapAreaBorder') > -1 || this.isTileMap && id === '') && !sf.base.isNullOrUndefined(this.dotNetRef)) {
      ...
      if (!sf.base.isNullOrUndefined(this.legendSettings) && this.legendSettings.mode === 'Interactive' && id.indexOf('_LayerIndex') > -1 && !sf.base.isNullOrUndefined(this.dotNetRef)) {
        ...
        if (id.indexOf('_shapeIndex') > -1 && this.legendSettings.type === 'Layers') {
          this.dotNetRef.invokeMethodAsync('RenderInteractive', fill, 0, 0, 0);
        } else if (id.indexOf('_MarkerIndex_') > -1 && this.legendSettings.type === 'Markers') {
          var layerIndex = parseInt(id.split('_LayerIndex_')[1].split('_')[0], 10);
          var markerIndex = parseInt(id.split('_MarkerIndex_')[1].split('_')[0], 10);
          var dataIndex = id.indexOf('_dataIndex_') !== -1 ? parseInt(id.split('_dataIndex_')[1].split('_')[0], 10) : null;
          this.dotNetRef.invokeMethodAsync('RenderInteractive', fill, layerIndex, markerIndex, dataIndex);
          ...
          var dataIndex = id.indexOf('_dataIndex_') !== -1 ? parseInt(id.split('_dataIndex_')[1].split('_')[0], 10) : null;
          this.dotNetRef.invokeMethodAsync('RenderInteractive', fill, layerIndex, bubbleIndex, dataIndex);
        }
      }
    ...
    SfMaps.prototype.highlightMap = function (event) {
      ...
      if (id.indexOf('_LayerIndex_') > -1 && !sf.base.isNullOrUndefined(this.dotNetRef)) {
        ...
        if (!sf.base.isNullOrUndefined(this.options.layerHighlightSettings[0]) && this.options.layerHighlightSettings[0].Enable) {
          if (!targetElement.classList.contains('mapShapeSelection')) {
    ...
    SfMaps.prototype.markerTranslate = function (element, factor, x, y, scale, template) {
      ...
      var latitudeValuePath = !sf.base.isNullOrUndefined(this.markerSettings[layerIndex][markerIndex].LatitudeValuePath) && this.markerSettings[layerIndex][markerIndex].LatitudeValuePath !== '' ? this.markerSettings[layerIndex][markerIndex].LatitudeValuePath : 'Latitude';
      var longitudeValuePath = !sf.base.isNullOrUndefined(this.markerSettings[layerIndex][markerIndex].LongitudeValuePath) && this.markerSettings[layerIndex][markerIndex].LongitudeValuePath !== '' ? this.markerSettings[layerIndex][markerIndex].LongitudeValuePath : 'Longitude';
    ...
    SfMaps.prototype.click = function (event) {
      ...
      if (id.indexOf("MapAreaBorder") > -1 || id.indexOf("shapeIndex") > -1 || id.indexOf("_Legend_") > -1 || id.indexOf("BubbleIndex") > -1 || id.indexOf("Zooming") > -1 || id.indexOf("MapMargin") > -1 || id === '') {
        this.mergeSeparation();
      }
  ...
  var Maps = {
    ...
    updateTileTranslatePoint: function updateTileTranslatePoint(tileTranslatePoint, translatePoint, areaRectX, areaRectY, areaRectWidth, areaRectHeight, marginLeft, marginTop, tileZoomLevel, id) {
      var instance = window.sfBlazor.getCompInstance(id);
      ...
      if (instance && instance.element) {
        ...
        if ((tileZoomLevel === instance.options.maxZoom || tileZoomLevel > 1 || tileZoomLevel === 1) && instance.previousId === "") {
          instance.toolbarOpacity(instance.toolbarButtonOpacity, instance.toolbarShapeOpacity);
    ...
    updateTranslatePoint: function updateTranslatePoint(translatePoint, areaRectX, areaRectY, areaRectWidth, areaRectHeight, marginLeft, marginTop, zoomFactor, id) {
      var instance = window.sfBlazor.getCompInstance(id);
      ...
      if (instance && instance.element) {
        ...
        if (instance.previousId.indexOf("_Reset_") > -1) {
          if (document.getElementById(instance.id + '_Zooming_ToolBar_Pan_Rect')) {
            if (instance.options.minZoom === 1) {
              document.getElementById(instance.id + '_Zooming_ToolBar_Pan_Path').setAttribute('fill', instance.toolbarColor);
              document.getElementById(instance.id + '_Zooming_ToolBar_Pan_Path').setAttribute('stroke', instance.toolbarColor);
            }

            instance.enableSelectionZoom = false;
            instance.isPan = true;
          }
        }

        if (zoomFactor === instance.options.maxZoom && instance.enableSelectionZoom) {
          instance.isPan = false;
        }

        if ((zoomFactor === instance.options.maxZoom || zoomFactor > 1 || zoomFactor === 1) && instance.previousId === "") {
          instance.toolbarOpacity(instance.toolbarButtonOpacity, instance.toolbarShapeOpacity);

          if (zoomFactor === instance.options.maxZoom) {
            if (document.getElementById(instance.id + '_Zooming_ToolBar_Zoom_Rect')) {
              document.getElementById(instance.id + '_Zooming_ToolBar_Zoom_Path').setAttribute('fill', instance.toolbarColor);
              document.getElementById(instance.id + '_Zooming_ToolBar_Zoom_Path').setAttribute('stroke', instance.toolbarColor);
            }
    ...
    exportToImage: function exportToImage(type, fileName, allowDownload, id) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              if (!(instance && instance.element)) return [3
              /*break*/
              , 2];
              return [4
              /*yield*/
              , instance.imageExport(type, fileName, allowDownload)];
...
}]);(async()=>{await import("/_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js").then(()=>{sfBlazor.loadDependencies('sfmaps');})})();