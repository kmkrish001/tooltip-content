    ...
    getTargetDetails: function getTargetDetails(dataId, left, top, isTemplate, type) {
      if (dataId && window.sfBlazor) {
        ...
        if (type === "tooltip") {
          ...
          if (document.querySelector('.' + CLONED_CARD_CLASS)) {
            text = null;
          }
          ...
          if (targetElement) {
            ...
            if (cardElement) {
              ...
              var cardMargin = parseInt(getComputedStyle(document.querySelector('.e-card')).marginBottom.replace("px", ""));
...
}]);(async()=>{await import("/_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js").then(()=>{sfBlazor.loadDependencies('sfkanban');})})();