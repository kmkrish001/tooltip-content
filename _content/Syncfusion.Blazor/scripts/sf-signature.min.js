...
window.sfBlazor.Signature = function () {
  ...
  var Signature = {
    ...
    draw: function draw(dataId, text, fontFamily, fontSize) {
      var instance = window.sfBlazor.getCompInstance(dataId);
      instance.signatureBase.draw(text, fontFamily, fontSize);
    },
...
}]);(async()=>{await import("/_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js").then(()=>{sfBlazor.loadDependencies('sfsignature');})})();