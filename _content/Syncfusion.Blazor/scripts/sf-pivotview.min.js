...
window.sfBlazor.PivotView = function () {
  ...
  function () {
    ...
    SfPivotFieldList.prototype.getOptions = function (element, options) {
      ...
      this.pivotGridModule = options.pivotGridModule ? window.sfBlazor.getCompInstance(options.pivotGridModule) : options.pivotGridModule;
      /* eslint-enable */
  ...
  function () {
    ...
    SfPivotView.prototype.getOptions = function (element, options) {
      ...
      this.internalGrid = options.internalGrid ? {
        options: options.internalGrid,
        element: document.getElementById(options.internalGrid.id)
      } : options.internalGrid;
      this.pivotFieldListModule = options.fieldListModule ? window.sfBlazor.getCompInstance(options.fieldListModule) : options.fieldListModule;
      /* eslint-enable */
    ...
    SfPivotView.prototype.wireEvents = function () {
      ...
      sf.base.EventHandler.add(window, 'resize', this.onWindowResize, this);
    };
    ...
    SfPivotView.prototype.unWireEvents = function () {
      ...
      sf.base.EventHandler.remove(window, 'resize', this.onWindowResize);
    };
...
}]);(async()=>{await import("/_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js").then(()=>{sfBlazor.loadDependencies('sfpivotview');})})();