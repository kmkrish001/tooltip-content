...
window.sfBlazor.Slider = function () {
  ...
  function () {
    ...
    SfSlider.prototype.updateValue = function (makeServerCall) {
      ...
      if (makeServerCall) {
        if (this.isMaterial && this.options.Tooltip !== null && !sf.base.isNullOrUndefined(this.materialHandle) && this.options.Type !== RANGESLIDER) {
...
}]);(async()=>{await import("/_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js").then(()=>{sfBlazor.loadDependencies('sfslider');})})();