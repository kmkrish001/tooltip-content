...
window.sfBlazor.Menu = function () {
  ...
  function () {
    ...
    SfMenu.prototype.subMenuPosition = function (args) {
      ...
      popupInstance.subMenuPosition(menu, args.isRtl, args.showItemOnClick, false, args.scrollHeight);
    };
  ...
  var Menu = {
    ...
    calculatePosition: function calculatePosition(args) {
      ...
      if (!sf.base.isNullOrUndefined(instance)) {
        instance.calculatePosition(args);
      }
    },
...
}]);(async()=>{await import("/_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js").then(()=>{sfBlazor.loadDependencies('sfmenu');})})();