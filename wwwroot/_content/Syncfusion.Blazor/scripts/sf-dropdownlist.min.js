...
window.sfBlazor.DropDownList = function () {
  ...
  function () {
    ...
    SfDropDownList.prototype.setSearchBoxPosition = function () {
      ...
      var headerHeight = headerElement ? headerElement.getBoundingClientRect().height : 0; // inset 4px is added from the script so removed it statically
...
}]);(async()=>{await import("/_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js").then(()=>{sfBlazor.loadDependencies('sfdropdownlist');})})();