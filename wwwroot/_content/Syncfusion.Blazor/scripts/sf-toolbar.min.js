...
window.sfBlazor.Toolbar = function () {
  ...
  var Toolbar = {
    ...
    hidePopup: function hidePopup(dataId) {
    ...
    hideItem: function hideItem(dataId, items) {
      var instance = window.sfBlazor.getCompInstance(dataId);
...
}]);(async()=>{await import("/_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js").then(()=>{sfBlazor.loadDependencies('sftoolbar');})})();