      ...
      if (instance.element) {
        ...
        if (isExpandModeChanged) {
          ...
          if (expandMode === 'Single') {
            instance.element.setAttribute('aria-multiselectable', 'false');

            if (instance.options.expandedIndices.length > 1) {
              instance.expandItem(false);
            }
          } else {
            instance.element.setAttribute('aria-multiselectable', 'true');
          }
        }
      }
    },
...
}]);(async()=>{await import("/_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js").then(()=>{sfBlazor.loadDependencies('sfaccordion');})})();