...
window.sf.svgbase = function (exports) {
  ...
  function findDirection(rX, rY, rect, arrowLocation, arrowPadding, top, bottom, left, tipX, tipY, controlName) {
    ...
    if (top) {
      ...
      direction = controlName === 'RangeNavigator' ? direction.concat(' L' + ' ' + (width + arrowPadding) + ' ' + (tipY - arrowPadding)) : direction.concat(' L' + ' ' + (width + arrowPadding) + ' ' + tipY);
      direction = controlName === 'RangeNavigator' ? direction.concat(' L' + ' ' + width + ' ' + arrowLocation.y) : direction.concat(' L' + ' ' + width + ' ' + (arrowLocation.y + arrowPadding));
      direction = direction.concat(' L' + ' ' + width + ' ' + (height - rY) + ' Q ' + width + ' ' + height + ' ' + (width - rX) + ' ' + height);
      direction = direction.concat(' L' + ' ' + (startX + rX) + ' ' + height + ' Q ' + startX + ' ' + height + ' ' + startX + ' ' + (height - rY) + ' z');
    } else {
      direction = direction.concat('M' + ' ' + (startX + rX) + ' ' + startY + ' Q ' + startX + ' ' + startY + ' ' + startX + ' ' + (startY + rY) + ' L' + ' ' + startX + ' ' + (arrowLocation.y - arrowPadding));
      direction = controlName === 'RangeNavigator' ? direction.concat(' L' + ' ' + (startX - arrowPadding) + ' ' + (tipY - arrowPadding)) : direction.concat(' L' + ' ' + (startX - arrowPadding) + ' ' + tipY);
      direction = controlName === 'RangeNavigator' ? direction.concat(' L' + ' ' + startX + ' ' + arrowLocation.y) : direction.concat(' L' + ' ' + startX + ' ' + (arrowLocation.y + arrowPadding));
