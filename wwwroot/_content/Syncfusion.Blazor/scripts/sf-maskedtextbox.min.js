(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["sf-maskedtextbox"],{
    ...
    SfMaskedTextBox.prototype.inputHandler = function (event) {
      if (this.options.mask) {
        ...
        if (event.data && event.inputType !== 'insertText') {
          ...
          if ((event.data || event.inputType) && this.isKeyDown) {
...
}]);(async()=>{await import("/_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js").then(()=>{sfBlazor.loadDependencies('sfmaskedtextbox');})})();