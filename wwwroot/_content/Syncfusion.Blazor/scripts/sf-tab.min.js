...
window.sfBlazor.Tab = function () {
  ...
  var Tab = {
    // eslint-disable-next-line max-len
    initialize: function initialize(dataId, element, options, dotnetRef, isLoaded, isCreatedEvent) {
      if (element && dataId) {
    ...
    contentReady: function contentReady(dataId, selectingIndex, isPopup) {
      var instance = window.sfBlazor.getCompInstance(dataId);

      if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        instance.element.classList.remove(CLS_FOCUS);
        instance.isPopup = isPopup;
    ...
    selectingContent: function selectingContent(dataId, selectingIndex) {
      ...
      if (!sf.base.isNullOrUndefined(instance) && !sf.base.isNullOrUndefined(instance.element)) {
        instance.selectingContent(selectingIndex);
        instance.setPersistence('tab' + instance.element.id, selectingIndex.toString());
    ...
    // eslint-disable-next-line max-len
    serverItemsChanged: function serverItemsChanged(dataId, selectedItem, animation, isVerticalIcon) {
      var instance = window.sfBlazor.getCompInstance(dataId);
    ...
    overflowMode: function overflowMode(dataId) {
      var instance = window.sfBlazor.getCompInstance(dataId);
...
}]);(async()=>{await import("/_content/Syncfusion.Blazor/scripts/syncfusion-blazor-base.min.js").then(()=>{sfBlazor.loadDependencies('sftab');})})();